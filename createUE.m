...
function ue = createUE(xPnts, yPnts, zPnts, servgNB, v, T, antDir)
...
% antDir - ориентация АР UE (направление оси симметрии) [азимут, наклон],
% градусы   
ue.ServgNB = servgNB; % номер обслуживающей gNB    
