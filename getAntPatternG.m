...
% azAng, elAng - направление (азимут, угол места), в котором рассчитывается
% КУ, градусы
...
% диаграммообразование, т.е. применение wS к коэфф. описывающим
...
% КУ АР в амплитудном выражении
g = abs(w);
% подавление обратного лепестка через 
% уменьшение КУ ДН в секторе углов от 90 до 270 градусов
if (backLobe == 1)
